...
let thomasWayne = {
  ...
  console.log('before firing', mugger.pistol.bullets);
  mugger.pistol.bullets.pop();
  mugger.pistol.bullets.pop();
  console.log('after firing', mugger.pistol.bullets);
  ...
  //console.log('--------->', marthaWayne.pearls);
  //console.log('the mugger ------->', mugger);
